    ...
    cy.intercept('GET', '**/api/v1/adapters/latest', { body: { items: [
      {
        ...
        description: null,
        keywords: [],
        maintainers: [{ username: 'biocypher', avatar_url: missingAvatarUrl, profile_url: 'https://github.com/biocypher' }],
        endorsement_count: 0,
    ...
    cy.intercept('GET', '**/api/v1/adapters/latest', { body: { items: [
      {
        ...
        description: null,
        keywords: [],
        maintainers: [{ username: 'biocypher', avatar_url: githubAvatarUrl, profile_url: 'https://github.com/biocypher' }],
        endorsement_count: 0,
        updated_at: '2026-07-06T00:00:00Z',
      },
    ] } })
