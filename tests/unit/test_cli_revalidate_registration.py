...
def test_revalidate_registration_command_reprocesses_corrected_invalid_source(
    tmp_path: Path,
) -> None:
    """Revalidate one corrected invalid source through the CLI."""
    ...
    assert "Registration revalidated" in result.output
